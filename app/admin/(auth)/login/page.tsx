            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="********"
                  required
                  className="w-full pl-10 pr-12 py-2.5 bg-gray-700 border border-gray-600 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all placeholder-gray-500"
                />
                <button
                  type="button"
