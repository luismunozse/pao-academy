...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, Megaphone, ArrowRight, Zap } from 'lucide-react';
import Link from 'next/link';
import { type Lang } from '../../../lib/i18n';

export default function MarketingDigitalExpressPage() {
  const [lang, setLang] = React.useState<Lang>('es');

  const courseData = {
    es: {
      title: 'Marketing Digital Express',
      category: 'Marketing Digital y Comunicación',
      categoryIcon: '📢',
      price: 33,
      description: 'Conocé las bases del marketing que usan las empresas. Aprendé estrategias probadas para posicionar tu marca y atraer clientes en el mundo digital.',
      highlights: [
        'Fundamentos del marketing digital',
        'SEO básico y posicionamiento web',
        'Publicidad en Google y Facebook Ads',
        'Métricas y análisis de campañas'
      ],
      modules: [
        'Introducción al marketing digital',
        'Estrategia de contenidos y buyer persona',
      ...
      testimonials: [
        {
          name: 'Luciana M.',
          quote: 'Este curso me dio las bases para manejar las campañas de mi emprendimiento.',
          role: 'Emprendedora'
        },
        {
          name: 'Roberto F.',
          quote: 'Ahora entiendo cómo funcionan los anuncios y puedo optimizar mi presupuesto.',
          role: 'Dueño de PyME'
        },
        {
          name: 'Sofía R.',
          quote: 'Muy práctico y directo. Ideal para quienes empiezan en marketing.',
          role: 'Community Manager'
        }
      ],
      relatedCourses: [
        { id: 'redes-sociales-pro', title: 'Redes Sociales Pro', description: 'Llevá tus redes al siguiente nivel' },
        { id: 'email-marketing-ia', title: 'Email Marketing con IA', description: 'Automatizá tus campañas' },
        { id: 'contenido-redes-ia', title: 'Contenido para Redes con IA', description: 'Creá contenido viral' }
      ]
    },
    en: {
      title: 'Digital Marketing Express',
      category: 'Digital Marketing & Communication',
      categoryIcon: '📢',
      price: 33,
      description: 'Learn the marketing foundations that companies use. Master proven strategies to position your brand and attract customers in the digital world.',
      highlights: [
        'Digital marketing fundamentals',
        'Basic SEO and web positioning',
        'Google and Facebook Ads advertising',
        'Metrics and campaign analysis'
      ],
      modules: [
        'Introduction to digital marketing',
        'Content strategy and buyer persona',
      ...
      testimonials: [
        {
          name: 'Luciana M.',
          quote: 'This course gave me the foundation to manage my business campaigns.',
          role: 'Entrepreneur'
        },
        {
          name: 'Roberto F.',
          quote: 'Now I understand how ads work and can optimize my budget.',
          role: 'SMB Owner'
        },
        {
          name: 'Sofía R.',
          quote: 'Very practical and direct. Ideal for those starting in marketing.',
          role: 'Community Manager'
        }
      ],
      relatedCourses: [
        { id: 'redes-sociales-pro', title: 'Social Media Pro', description: 'Take your social media to the next level' },
        { id: 'email-marketing-ia', title: 'Email Marketing with AI', description: 'Automate your campaigns' },
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><Megaphone size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para dominar el marketing digital?' : 'Ready to master digital marketing?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y transformá la presencia digital de tu marca.' : 'Start today and transform your brand\'s digital presence.'}</p>
