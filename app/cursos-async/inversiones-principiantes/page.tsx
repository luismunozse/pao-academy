...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, TrendingUp, ArrowRight, Zap } from 'lucide-react';
...
export default function InversionesPrincipiantesPage() {
  ...
  const courseData = {
    es: {
      ...
      categoryIcon: '💼',
      price: 35,
      description: 'Dá tus primeros pasos en el mundo de la inversión. Aprende los conceptos fundamentales para hacer crecer tu dinero de forma inteligente.',
      highlights: ['Conceptos básicos de inversión', 'Tipos de activos financieros', 'Gestión del riesgo', 'Estrategias para principiantes'],
      modules: ['Fundamentos de la inversión', 'Acciones y mercado bursátil', 'Bonos y renta fija', 'Fondos de inversión y ETFs', 'Diversificación y portafolio', 'Tu primera inversión paso a paso'],
      duration: '6 horas de contenido', format: '100% on-demand', access: 'Acceso de por vida', certificate: 'Certificado digital incluido',
      testimonials: [
        { name: 'Alejandro R.', quote: 'Por fin entiendo cómo funciona la bolsa. Ya hice mi primera inversión.', role: 'Profesional IT' },
        { name: 'Gabriela M.', quote: 'Explicaciones claras sin tecnicismos. Perfecto para empezar.', role: 'Emprendedora' },
        { name: 'Manuel L.', quote: 'El módulo de ETFs me abrió los ojos. Gran curso para principiantes.', role: 'Empleado' }
      ],
      relatedCourses: [
        { id: 'finanzas-smart', title: 'Finanzas Smart', description: 'Ordená tus finanzas primero' },
        { id: 'excel-finanzas', title: 'Excel para Finanzas', description: 'Analiza tus inversiones' },
        { id: 'contabilidad-sin-complicaciones', title: 'Contabilidad Sin Complicaciones', description: 'Entiende los números' }
      ]
    },
    en: {
      ...
      categoryIcon: '💼',
      price: 35,
      description: 'Take your first steps in the investment world. Learn the fundamental concepts to grow your money intelligently.',
      highlights: ['Basic investment concepts', 'Types of financial assets', 'Risk management', 'Strategies for beginners'],
      modules: ['Investment fundamentals', 'Stocks and stock market', 'Bonds and fixed income', 'Investment funds and ETFs', 'Diversification and portfolio', 'Your first investment step by step'],
      duration: '6 hours of content', format: '100% on-demand', access: 'Lifetime access', certificate: 'Digital certificate included',
      testimonials: [
        { name: 'Alejandro R.', quote: 'I finally understand how the stock market works. I already made my first investment.', role: 'IT Professional' },
        { name: 'Gabriela M.', quote: 'Clear explanations without jargon. Perfect for beginners.', role: 'Entrepreneur' },
        { name: 'Manuel L.', quote: 'The ETF module opened my eyes. Great course for beginners.', role: 'Employee' }
      ],
      relatedCourses: [
        { id: 'finanzas-smart', title: 'Smart Finance', description: 'Organize your finances first' },
        { id: 'excel-finanzas', title: 'Excel for Finance', description: 'Analyze your investments' },
        { id: 'contabilidad-sin-complicaciones', title: 'Accounting Without Complications', description: 'Understand the numbers' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><TrendingUp size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para empezar a invertir?' : 'Ready to start investing?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y hacé crecer tu dinero de forma inteligente.' : 'Start today and grow your money intelligently.'}</p>
