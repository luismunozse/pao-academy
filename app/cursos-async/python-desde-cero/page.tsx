...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, Code2, ArrowRight, Zap } from 'lucide-react';
import Link from 'next/link';
import { type Lang } from '../../../lib/i18n';

export default function PythonDesdeCeroPage() {
  ...
  const courseData = {
    es: {
      ...
      categoryIcon: '💻',
      price: 45,
      description: 'Aprendé el lenguaje más popular del mercado laboral. Desde los fundamentos hasta proyectos prácticos que potencian tu CV.',
      highlights: ['Sintaxis y fundamentos de Python', 'Estructuras de datos y algoritmos', 'Automatización de tareas', 'Proyectos prácticos reales'],
      modules: ['Introducción a Python y configuración', 'Variables, tipos de datos y operadores', 'Estructuras de control y bucles', 'Funciones y módulos', 'Listas, diccionarios y conjuntos', 'Manejo de archivos y excepciones', 'Proyecto final: Automatización'],
      duration: '12 horas de contenido',
      format: '100% on-demand',
      access: 'Acceso de por vida',
      certificate: 'Certificado digital incluido',
      testimonials: [
        { name: 'Sebastián R.', quote: 'Empecé sin saber nada de programación y ahora automatizo tareas en mi trabajo.', role: 'Analista de Negocio' },
        { name: 'Mariana L.', quote: 'El curso es muy didáctico. Los ejercicios prácticos hacen la diferencia.', role: 'Estudiante' },
        { name: 'Nicolás F.', quote: 'Python me abrió puertas a roles de data que antes parecían imposibles.', role: 'Analista de Datos Jr.' }
      ],
      relatedCourses: [
        { id: 'ia-generativa', title: 'IA Generativa para Todos', description: 'Aplicá IA en tu trabajo' },
        { id: 'excel-pro', title: 'Excel Pro desde Cero', description: 'Complementá con análisis' },
        { id: 'powerbi-express', title: 'Power BI Express', description: 'Visualiza tus datos' }
      ]
    },
    en: {
      ...
      categoryIcon: '💻',
      price: 45,
      description: 'Learn the most popular language in the job market. From fundamentals to practical projects that boost your CV.',
      highlights: ['Python syntax and fundamentals', 'Data structures and algorithms', 'Task automation', 'Real practical projects'],
      modules: ['Introduction to Python and setup', 'Variables, data types and operators', 'Control structures and loops', 'Functions and modules', 'Lists, dictionaries and sets', 'File handling and exceptions', 'Final project: Automation'],
      duration: '12 hours of content',
      format: '100% on-demand',
      access: 'Lifetime access',
      certificate: 'Digital certificate included',
      testimonials: [
        { name: 'Sebastián R.', quote: 'I started knowing nothing about programming and now I automate tasks at work.', role: 'Business Analyst' },
        { name: 'Mariana L.', quote: 'The course is very didactic. The practical exercises make the difference.', role: 'Student' },
        { name: 'Nicolás F.', quote: 'Python opened doors to data roles that seemed impossible before.', role: 'Jr. Data Analyst' }
      ],
      relatedCourses: [
        { id: 'ia-generativa', title: 'Generative AI for Everyone', description: 'Apply AI at work' },
        { id: 'excel-pro', title: 'Excel Pro from Zero', description: 'Complement with analysis' },
        { id: 'powerbi-express', title: 'Power BI Express', description: 'Visualize your data' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><Code2 size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para aprender Python?' : 'Ready to learn Python?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y abrí nuevas puertas en tu carrera tech.' : 'Start today and open new doors in your tech career.'}</p>
          <button style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '1rem 2.5rem', fontSize: '1.125rem', fontWeight: 700, color: '#3B82F6', background: 'white', border: 'none', borderRadius: '0.75rem', cursor: 'pointer', boxShadow: '0 10px 25px rgba(0, 0, 0, 0.2)' }}>{lang === 'es' ? 'Comprar por USD $45' : 'Buy for USD $45'}<ArrowRight size={20} /></button>
        </div>
      </section>
    </div>
  );
