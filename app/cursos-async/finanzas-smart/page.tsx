...
export default function FinanzasSmartPage() {
  ...
  const courseData = {
    es: {
      ...
      categoryIcon: '💼',
      price: 32,
      description: 'Organizá tus ingresos y gastos con técnicas simples. Aprende a tomar el control de tu dinero y construir un futuro financiero sólido.',
      highlights: ['Control de ingresos y gastos', 'Presupuestos inteligentes', 'Estrategias de ahorro', 'Metas financieras claras'],
      modules: ['Diagnóstico financiero personal', 'Creación de presupuestos efectivos', 'Métodos de ahorro que funcionan', 'Gestión de deudas inteligente', 'Planificación de metas financieras', 'Herramientas digitales para finanzas'],
      duration: '5 horas de contenido',
      format: '100% on-demand',
      access: 'Acceso de por vida',
      certificate: 'Certificado digital incluido',
      testimonials: [
        { name: 'Carolina T.', quote: 'Por fin entiendo a dónde va mi dinero. Ahora ahorro sin sacrificio.', role: 'Profesional independiente' },
        { name: 'Andrés M.', quote: 'Simple y práctico. Empecé a aplicar desde la primera clase.', role: 'Empleado' },
        { name: 'Daniela V.', quote: 'Me ayudó a salir de deudas y empezar a invertir. Muy recomendado.', role: 'Emprendedora' }
      ],
      relatedCourses: [
        { id: 'excel-finanzas', title: 'Excel para Finanzas', description: 'Controla tus números como pro' },
    ...
    en: {
      ...
      testimonials: [
        ...
        { name: 'Andrés M.', quote: 'Simple and practical. I started applying from the first class.', role: 'Employee' },
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para tomar el control de tus finanzas?' : 'Ready to take control of your finances?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y construí un futuro financiero sólido.' : 'Start today and build a solid financial future.'}</p>
