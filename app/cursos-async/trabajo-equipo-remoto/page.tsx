...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, Users, ArrowRight, Zap } from 'lucide-react';
import Link from 'next/link';
import { type Lang } from '../../../lib/i18n';

export default function TrabajoEquipoRemotoPage() {
  ...
  const courseData = {
    es: {
      ...
      categoryIcon: '👩‍💻',
      price: 27,
      description: 'Colaborá eficazmente desde cualquier lugar del mundo. Dominá las herramientas y técnicas para trabajar en equipos distribuidos con alta productividad.',
      highlights: [
        'Comunicación asíncrona efectiva',
        'Herramientas de colaboración remota',
        'Gestión del tiempo en home office',
        'Construcción de confianza a distancia'
      ],
      modules: [
        'Desafíos y oportunidades del trabajo remoto',
        ...
        'Cultura y confianza en equipos distribuidos'
      ],
      ...
      testimonials: [
        {
          name: 'Matías B.',
          quote: 'Mejoré enormemente la comunicación con mi equipo remoto. Muy práctico.',
          role: 'Tech Lead'
        },
        {
          name: 'Carolina V.',
          quote: 'El módulo de reuniones virtuales me ahorró horas de calls innecesarias.',
          role: 'Project Manager'
        },
        {
          name: 'Andrés G.',
          quote: 'Aprendí a ser productivo en home office sin quemarme.',
          role: 'Desarrollador'
        }
      ],
      relatedCourses: [
        { id: 'comunicacion-efectiva-pro', title: 'Comunicación Efectiva Pro', description: 'Mejorá tu comunicación general' },
        { id: 'notion-productividad', title: 'Notion para la Productividad', description: 'Organizá tu trabajo remoto' },
        { id: 'trello-asana', title: 'Trello & Asana Ágil', description: 'Gestión de proyectos remota' }
      ]
    },
    en: {
      ...
      categoryIcon: '👩‍💻',
      price: 27,
      description: 'Collaborate effectively from anywhere in the world. Master the tools and techniques to work in distributed teams with high productivity.',
      highlights: [
        'Effective asynchronous communication',
        'Remote collaboration tools',
        'Time management in home office',
      ...
      modules: [
        ...
        'Culture and trust in distributed teams'
      ],
      ...
      testimonials: [
        {
          name: 'Matías B.',
          quote: 'I greatly improved communication with my remote team. Very practical.',
          role: 'Tech Lead'
        },
        {
          name: 'Carolina V.',
          quote: 'The virtual meetings module saved me hours of unnecessary calls.',
          role: 'Project Manager'
        },
        {
          name: 'Andrés G.',
          quote: 'I learned to be productive in home office without burning out.',
          role: 'Developer'
        }
      ],
      relatedCourses: [
        { id: 'comunicacion-efectiva-pro', title: 'Effective Communication Pro', description: 'Improve your overall communication' },
        { id: 'notion-productividad', title: 'Notion for Productivity', description: 'Organize your remote work' },
        { id: 'trello-asana', title: 'Agile Trello & Asana', description: 'Remote project management' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><Users size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para destacar en equipos remotos?' : 'Ready to excel in remote teams?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y convertite en un colaborador remoto de alto valor.' : 'Start today and become a high-value remote collaborator.'}</p>
