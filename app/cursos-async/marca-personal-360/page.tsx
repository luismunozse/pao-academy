...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, User, ArrowRight, Zap, Sparkles } from 'lucide-react';
import Link from 'next/link';
import { type Lang } from '../../../lib/i18n';

export default function MarcaPersonal360Page() {
  const [lang, setLang] = React.useState<Lang>('es');

  const courseData = {
    es: {
      title: 'Tu Marca Personal 360',
      category: 'Marca Personal y Creación de Contenido con IA',
      categoryIcon: '🌟',
      price: 40,
      hasAI: true,
      description: 'Definí tu identidad profesional y diferenciá tu perfil. Construí una marca personal sólida que te posicione como referente en tu industria usando herramientas de IA.',
      highlights: [
      ...
      modules: [
        'Qué es marca personal y por qué importa',
        'Descubriendo tu propuesta de valor única',
        'Storytelling personal y narrativa profesional',
      ...
      testimonials: [
        {
          name: 'Juliana M.',
          quote: 'Pasé de no saber qué publicar a tener una estrategia clara. Excelente.',
          role: 'Coach'
        },
        {
          name: 'Ricardo L.',
          quote: 'Las herramientas de IA me ahorraron horas de trabajo en contenido.',
          role: 'Consultor Freelance'
        },
        {
          name: 'Daniela S.',
          quote: 'Definí mi propuesta de valor y ahora recibo más propuestas de trabajo.',
          role: 'Diseñadora UX'
        }
      ],
      relatedCourses: [
        { id: 'linkedin-pro-ia', title: 'LinkedIn Pro con IA', description: 'Optimizá tu perfil de LinkedIn' },
        { id: 'contenido-redes-ia', title: 'Contenido para Redes con IA', description: 'Creá contenido viral' },
        { id: 'presentaciones-impacto', title: 'Presentaciones de Impacto', description: 'Presentá tu marca con confianza' }
      ]
    },
    en: {
      title: 'Your 360 Personal Brand',
      category: 'Personal Branding & AI Content Creation',
      categoryIcon: '🌟',
      price: 40,
      hasAI: true,
      description: 'Define your professional identity and differentiate your profile. Build a solid personal brand that positions you as a reference in your industry using AI tools.',
      highlights: [
      ...
      modules: [
        ...
        'Personal storytelling and professional narrative',
        'AI content strategy',
      ...
      testimonials: [
        {
          name: 'Juliana M.',
          quote: 'I went from not knowing what to post to having a clear strategy. Excellent.',
          role: 'Coach'
        },
        {
          name: 'Ricardo L.',
          quote: 'AI tools saved me hours of content work.',
          role: 'Freelance Consultant'
        },
        {
          name: 'Daniela S.',
          quote: 'I defined my value proposition and now I receive more job offers.',
          role: 'UX Designer'
        }
      ],
      relatedCourses: [
        { id: 'linkedin-pro-ia', title: 'LinkedIn Pro with AI', description: 'Optimize your LinkedIn profile' },
        { id: 'contenido-redes-ia', title: 'Social Media Content with AI', description: 'Create viral content' },
        { id: 'presentaciones-impacto', title: 'Impact Presentations', description: 'Present your brand with confidence' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><User size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para construir tu marca personal?' : 'Ready to build your personal brand?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y posicionate como referente en tu industria.' : 'Start today and position yourself as a reference in your industry.'}</p>
          <button style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '1rem 2.5rem', fontSize: '1.125rem', fontWeight: 700, color: '#3B82F6', background: 'white', border: 'none', borderRadius: '0.75rem', cursor: 'pointer', boxShadow: '0 10px 25px rgba(0, 0, 0, 0.2)' }}>{lang === 'es' ? 'Comprar por USD $40' : 'Buy for USD $40'}<ArrowRight size={20} /></button>
        </div>
      </section>
    </div>
  );
