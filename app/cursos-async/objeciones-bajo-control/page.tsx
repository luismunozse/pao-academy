...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, Shield, ArrowRight, Zap } from 'lucide-react';
import Link from 'next/link';
import { type Lang } from '../../../lib/i18n';

export default function ObjecionesBajoControlPage() {
  const [lang, setLang] = React.useState<Lang>('es');

  const courseData = {
    es: {
      title: 'Objeciones bajo Control',
      category: 'Ventas y Customer Experience',
      categoryIcon: '🤝',
      price: 28,
      description: 'Responde con seguridad y convertí un "no" en oportunidad. Dominá las técnicas profesionales para manejar cualquier objeción y cerrar más ventas.',
      highlights: [
        'Psicología detrás de las objeciones',
        'Técnicas de respuesta efectiva',
        'Objeciones de precio y competencia',
        'Scripts y frameworks probados'
      ],
      modules: [
        'Por qué los clientes objetan',
        'Las 5 objeciones más comunes',
        'Framework LAER para responder',
        'Objeciones de precio: cómo manejarlas',
        'Objeciones de competencia y timing',
      ...
      testimonials: [
        {
          name: 'Miguel A.',
          quote: 'Antes las objeciones me paralizaban. Ahora las espero con confianza.',
          role: 'Vendedor Senior'
        },
        {
          name: 'Patricia M.',
          quote: 'El framework LAER me cambió la vida. Muy efectivo.',
          role: 'Account Executive'
        },
        {
          name: 'Diego C.',
          quote: 'Subí mi tasa de cierre un 30% después de aplicar estas técnicas.',
          role: 'Sales Manager'
        }
      ],
      relatedCourses: [
        { id: 'ventas-101', title: 'Ventas 101', description: 'Dominá el proceso completo de ventas' },
        { id: 'atencion-cliente-5star', title: 'Atención al Cliente 5 Estrellas', description: 'Mejorá tu relación con clientes' },
        { id: 'comunicacion-efectiva-pro', title: 'Comunicación Efectiva Pro', description: 'Comunicá con más impacto' }
      ]
    },
    en: {
      title: 'Objections Under Control',
      category: 'Sales & Customer Experience',
      categoryIcon: '🤝',
      price: 28,
      description: 'Respond with confidence and turn a "no" into an opportunity. Master professional techniques to handle any objection and close more sales.',
      highlights: [
        'Psychology behind objections',
        'Effective response techniques',
        'Price and competition objections',
        'Proven scripts and frameworks'
      ],
      modules: [
        'Why customers object',
        'The 5 most common objections',
        'LAER framework for responding',
        'Price objections: how to handle them',
      ...
      testimonials: [
        {
          name: 'Miguel A.',
          quote: 'Objections used to paralyze me. Now I expect them with confidence.',
          role: 'Senior Salesperson'
        },
        {
          name: 'Patricia M.',
          quote: 'The LAER framework changed my life. Very effective.',
          role: 'Account Executive'
        },
        {
          name: 'Diego C.',
          quote: 'I increased my closing rate by 30% after applying these techniques.',
          role: 'Sales Manager'
        }
      ],
      relatedCourses: [
        { id: 'ventas-101', title: 'Sales 101', description: 'Master the complete sales process' },
        { id: 'atencion-cliente-5star', title: '5-Star Customer Service', description: 'Improve your customer relationships' },
        { id: 'comunicacion-efectiva-pro', title: 'Effective Communication Pro', description: 'Communicate with more impact' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><Shield size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para dominar las objeciones?' : 'Ready to master objections?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y convertí cada "no" en una oportunidad de cierre.' : 'Start today and turn every "no" into a closing opportunity.'}</p>
