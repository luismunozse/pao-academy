...
export default function ComunicacionAsertivaPage() {
  ...
  const courseData = {
    es: {
      ...
      categoryIcon: '🧠',
      price: 31,
      description: 'Mejorá cómo transmitís tus ideas y generá impacto. Técnicas para comunicarte con claridad, confianza y efectividad en cualquier contexto.',
      highlights: ['Técnicas de comunicación efectiva', 'Manejo de conversaciones difíciles', 'Lenguaje verbal y no verbal', 'Escucha activa'],
      modules: ['Fundamentos de la comunicación asertiva', 'Estilos de comunicación', 'Técnicas para decir NO', 'Manejo de conflictos', 'Comunicación en el trabajo', 'Práctica y feedback'],
      duration: '5 horas de contenido', format: '100% on-demand', access: 'Acceso de por vida', certificate: 'Certificado digital incluido',
      testimonials: [
        { name: 'Andrea P.', quote: 'Aprendí a poner límites sin sentirme culpable. Cambió mis relaciones laborales.', role: 'Coordinadora de RH' },
        { name: 'Matías G.', quote: 'Las técnicas de escucha activa mejoraron mi relación con clientes.', role: 'Ejecutivo de Ventas' },
        { name: 'Carla R.', quote: 'Muy práctico. Apliqué lo aprendido desde el primer día.', role: 'Gerente de Proyecto' }
      ],
      relatedCourses: [
        { id: 'presentaciones-impacto', title: 'Presentaciones de Impacto', description: 'Presenta con confianza' },
        { id: 'comunicacion-efectiva-pro', title: 'Comunicación Efectiva Pro', description: 'Nivel avanzado' },
        { id: 'productividad-10x', title: 'Productividad 10X', description: 'Multiplica resultados' }
      ]
    },
    en: {
      ...
      categoryIcon: '🧠',
      price: 31,
      description: 'Improve how you convey your ideas and generate impact. Techniques to communicate with clarity, confidence and effectiveness in any context.',
      highlights: ['Effective communication techniques', 'Handling difficult conversations', 'Verbal and non-verbal language', 'Active listening'],
      modules: ['Assertive communication fundamentals', 'Communication styles', 'Techniques to say NO', 'Conflict management', 'Communication at work', 'Practice and feedback'],
      duration: '5 hours of content', format: '100% on-demand', access: 'Lifetime access', certificate: 'Digital certificate included',
      testimonials: [
        { name: 'Andrea P.', quote: 'I learned to set limits without feeling guilty. It changed my work relationships.', role: 'HR Coordinator' },
        { name: 'Matías G.', quote: 'Active listening techniques improved my relationship with clients.', role: 'Sales Executive' },
        { name: 'Carla R.', quote: 'Very practical. I applied what I learned from day one.', role: 'Project Manager' }
      ],
      relatedCourses: [
        { id: 'presentaciones-impacto', title: 'Impact Presentations', description: 'Present with confidence' },
        { id: 'comunicacion-efectiva-pro', title: 'Effective Communication Pro', description: 'Advanced level' },
        { id: 'productividad-10x', title: '10X Productivity', description: 'Multiply results' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para comunicarte con impacto?' : 'Ready to communicate with impact?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y transformá tus relaciones profesionales.' : 'Start today and transform your professional relationships.'}</p>
