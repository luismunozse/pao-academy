...
export default function ContenidoRedesIAPage() {
  ...
  const courseData = {
    es: {
      title: 'Contenido para Redes con IA',
      category: 'Marca Personal y Creación de Contenido con IA',
      categoryIcon: '🌟',
      price: 35,
      hasAI: true,
      description: 'Generá copies, guiones y diseños con Inteligencia Artificial. Aprendé a crear contenido viral para redes sociales usando las últimas herramientas de IA.',
      highlights: [
        'Generación de copies con ChatGPT',
        'Diseño de posts con IA generativa',
        'Guiones para videos y reels',
        'Calendarios de contenido automatizados'
      ],
      modules: [
        'Introducción a la creación de contenido con IA',
        'Copies irresistibles con ChatGPT y Claude',
        'Imágenes y diseños con Midjourney y DALL-E',
        'Guiones para videos cortos',
        'Automatización del calendario de contenido',
        'Workflow completo de creación con IA'
      ],
      ...
      testimonials: [
        {
          name: 'Romina F.',
          quote: 'Pasé de tardar horas en un post a crearlo en minutos. Increíble.',
          role: 'Community Manager'
        },
        {
          name: 'Lucas T.',
          quote: 'Las herramientas de IA cambiaron mi forma de crear contenido.',
          role: 'Creador de Contenido'
        },
        {
          name: 'Agustina P.',
          quote: 'Mis posts ahora tienen mucho más engagement gracias a los prompts.',
          role: 'Emprendedora'
        }
      ],
      relatedCourses: [
        ...
        { id: 'redes-sociales-pro', title: 'Redes Sociales Pro', description: 'Estrategia completa de redes' }
      ]
    },
    en: {
      ...
      price: 35,
      hasAI: true,
      description: 'Generate copies, scripts and designs with Artificial Intelligence. Learn to create viral social media content using the latest AI tools.',
      highlights: [
        'Copy generation with ChatGPT',
        'Post design with generative AI',
        'Scripts for videos and reels',
        'Automated content calendars'
      ],
      modules: [
        'Introduction to AI content creation',
        'Irresistible copies with ChatGPT and Claude',
        'Images and designs with Midjourney and DALL-E',
      ...
      testimonials: [
        {
          name: 'Romina F.',
          quote: 'I went from spending hours on a post to creating it in minutes. Incredible.',
          role: 'Community Manager'
        },
        {
          name: 'Lucas T.',
          quote: 'AI tools changed the way I create content.',
          role: 'Content Creator'
        },
        {
          name: 'Agustina P.',
          quote: 'My posts now have much more engagement thanks to the prompts.',
          role: 'Entrepreneur'
        }
      ],
      relatedCourses: [
        ...
        { id: 'redes-sociales-pro', title: 'Social Media Pro', description: 'Complete social media strategy' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><PenTool size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para crear contenido viral con IA?' : 'Ready to create viral content with AI?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y transformá tu creación de contenido.' : 'Start today and transform your content creation.'}</p>
