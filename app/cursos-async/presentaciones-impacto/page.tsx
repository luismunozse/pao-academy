...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, Presentation, ArrowRight, Zap } from 'lucide-react';
import Link from 'next/link';
import { type Lang } from '../../../lib/i18n';

export default function PresentacionesImpactoPage() {
  ...
  const courseData = {
    es: {
      ...
      categoryIcon: '👩‍💻',
      price: 29,
      description: 'Creá exposiciones que cautiven y convenzan. Aprendé a diseñar y presentar con confianza para generar el impacto que necesitás en tu audiencia.',
      highlights: [
        'Diseño de presentaciones visuales',
        'Storytelling para presentar',
        'Técnicas de oratoria y presencia',
        'Manejo del nerviosismo'
      ],
      modules: [
        'Estructura de una presentación efectiva',
        'Storytelling: cómo contar historias que conectan',
        'Diseño visual que impacta',
        'Técnicas de oratoria y voz',
        'Lenguaje corporal y presencia escénica',
        'Práctica: presentaciones con feedback'
      ],
      ...
      testimonials: [
        {
          name: 'Federico L.',
          quote: 'Pasé de tener pánico escénico a disfrutar presentar. Transformador.',
          role: 'Gerente Comercial'
        },
        {
          name: 'Camila D.',
          quote: 'El módulo de storytelling cambió mis presentaciones por completo.',
          role: 'Marketing Lead'
        },
        {
          name: 'Santiago P.',
          quote: 'Mis clientes ahora dicen que mis propuestas son las más claras que reciben.',
          role: 'Consultor'
        }
      ],
      relatedCourses: [
        { id: 'comunicacion-efectiva-pro', title: 'Comunicación Efectiva Pro', description: 'Mejorá tu comunicación general' },
        { id: 'diseno-canva', title: 'Diseño con Canva', description: 'Creá slides visuales increíbles' },
        { id: 'marca-personal-360', title: 'Tu Marca Personal 360', description: 'Posicionate como experto' }
      ]
    },
    en: {
      ...
      categoryIcon: '👩‍💻',
      price: 29,
      description: 'Create presentations that captivate and convince. Learn to design and present with confidence to generate the impact you need on your audience.',
      highlights: [
        'Visual presentation design',
        'Storytelling for presenting',
        'Public speaking and presence techniques',
        'Nervousness management'
      ],
      modules: [
        'Effective presentation structure',
        'Storytelling: how to tell connecting stories',
        'Impactful visual design',
        'Public speaking and voice techniques',
      ...
      testimonials: [
        {
          name: 'Federico L.',
          quote: 'I went from having stage fright to enjoying presenting. Transformative.',
          role: 'Commercial Manager'
        },
        {
          name: 'Camila D.',
          quote: 'The storytelling module completely changed my presentations.',
          role: 'Marketing Lead'
        },
        {
          name: 'Santiago P.',
          quote: 'My clients now say my proposals are the clearest they receive.',
          role: 'Consultant'
        }
      ],
      relatedCourses: [
        { id: 'comunicacion-efectiva-pro', title: 'Effective Communication Pro', description: 'Improve your overall communication' },
        { id: 'diseno-canva', title: 'Design with Canva', description: 'Create amazing visual slides' },
        { id: 'marca-personal-360', title: 'Your 360 Personal Brand', description: 'Position yourself as an expert' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><Presentation size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para presentar con confianza?' : 'Ready to present with confidence?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y transformá tus presentaciones en experiencias memorables.' : 'Start today and transform your presentations into memorable experiences.'}</p>
