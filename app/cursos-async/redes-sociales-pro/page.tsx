...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, Share2, ArrowRight, Zap } from 'lucide-react';
import Link from 'next/link';
import { type Lang } from '../../../lib/i18n';

export default function RedesSocialesProPage() {
  ...
  const courseData = {
    es: {
      ...
      categoryIcon: '📢',
      price: 36,
      description: 'Hacé crecer un negocio con estrategias en Instagram y Facebook. Aprendé a crear contenido que conecta, generar engagement y convertir seguidores en clientes.',
      highlights: [
        'Estrategia de contenidos para redes',
        'Crecimiento orgánico en Instagram',
        'Facebook Business y publicidad',
        'Calendario editorial y planificación'
      ],
      modules: [
        'Fundamentos de redes sociales para negocios',
        'Instagram: algoritmo y estrategia de crecimiento',
        'Creación de contenido que convierte',
        'Facebook Business Manager',
        'Métricas y análisis de rendimiento',
        'Plan de acción y calendario editorial'
      ],
      ...
      testimonials: [
        {
          name: 'Carolina T.',
          quote: 'Tripliqué mis seguidores en 3 meses aplicando las estrategias del curso.',
          role: 'Influencer'
        },
        {
          name: 'Martín G.',
          quote: 'Ahora tengo un plan claro para mis redes y los resultados se notan.',
          role: 'Dueño de Tienda Online'
        },
        {
          name: 'Paula V.',
          quote: 'El módulo de Instagram fue revelador. Muy recomendado.',
          role: 'Social Media Manager'
        }
      ],
      relatedCourses: [
        { id: 'marketing-digital-express', title: 'Marketing Digital Express', description: 'Completá tu formación en marketing' },
        { id: 'contenido-redes-ia', title: 'Contenido para Redes con IA', description: 'Automatizá tu creación de contenido' },
        { id: 'reels-shorts-ia', title: 'Reels y Shorts con IA', description: 'Creá videos virales' }
      ]
    },
    en: {
      ...
      categoryIcon: '📢',
      price: 36,
      description: 'Grow a business with Instagram and Facebook strategies. Learn to create connecting content, generate engagement and convert followers into customers.',
      highlights: [
      ...
      modules: [
        'Social media fundamentals for business',
        'Instagram: algorithm and growth strategy',
      ...
      testimonials: [
        {
          name: 'Carolina T.',
          quote: 'I tripled my followers in 3 months applying the course strategies.',
          role: 'Influencer'
        },
        {
          name: 'Martín G.',
          quote: 'Now I have a clear plan for my social media and the results show.',
          role: 'Online Store Owner'
        },
        {
          name: 'Paula V.',
          quote: 'The Instagram module was eye-opening. Highly recommended.',
          role: 'Social Media Manager'
        }
      ],
      relatedCourses: [
        { id: 'marketing-digital-express', title: 'Digital Marketing Express', description: 'Complete your marketing training' },
        { id: 'contenido-redes-ia', title: 'Social Media Content with AI', description: 'Automate your content creation' },
        { id: 'reels-shorts-ia', title: 'Reels and Shorts with AI', description: 'Create viral videos' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><Share2 size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para dominar las redes sociales?' : 'Ready to master social media?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y transformá tus redes en una máquina de crecimiento.' : 'Start today and transform your social media into a growth machine.'}</p>
          <button style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '1rem 2.5rem', fontSize: '1.125rem', fontWeight: 700, color: '#3B82F6', background: 'white', border: 'none', borderRadius: '0.75rem', cursor: 'pointer', boxShadow: '0 10px 25px rgba(0, 0, 0, 0.2)' }}>{lang === 'es' ? 'Comprar por USD $36' : 'Buy for USD $36'}<ArrowRight size={20} /></button>
        </div>
      </section>
    </div>
  );
