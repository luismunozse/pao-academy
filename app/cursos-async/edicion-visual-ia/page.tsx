...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, Wand2, ArrowRight, Zap, Sparkles } from 'lucide-react';
import Link from 'next/link';
import { type Lang } from '../../../lib/i18n';

export default function EdicionVisualIAPage() {
  const [lang, setLang] = React.useState<Lang>('es');

  const courseData = {
    es: {
      title: 'Edición Visual con IA',
      category: 'Marca Personal y Creación de Contenido con IA',
      categoryIcon: '🌟',
      price: 28,
      hasAI: true,
      description: 'Transformá imágenes y videos en piezas profesionales. Dominá las herramientas de IA para edición visual y creá contenido de alto impacto sin ser experto.',
      highlights: [
        'Edición de imágenes con IA',
        'Mejora y retoque automático',
        'Generación de backgrounds y elementos',
        'Edición de video con herramientas IA'
      ],
      modules: [
        'Introducción a la edición visual con IA',
        'Herramientas de mejora automática de imágenes',
        'Generación y edición con Midjourney y DALL-E',
        'Remoción de fondos y objetos con IA',
        'Edición de video con CapCut y Runway',
        'Workflow profesional de edición con IA'
      ],
      ...
      testimonials: [
        {
          name: 'Natalia R.',
          quote: 'Ahora edito mis fotos de producto en minutos. La IA es magia.',
          role: 'Dueña de E-commerce'
        },
        {
          name: 'Gustavo P.',
          quote: 'El módulo de remoción de fondos me ahorró horas de trabajo.',
          role: 'Fotógrafo'
        },
        {
          name: 'Micaela S.',
          quote: 'Mis diseños ahora se ven mucho más profesionales gracias a estas herramientas.',
          role: 'Social Media Manager'
        }
      ],
      relatedCourses: [
        { id: 'photoshop-start', title: 'Photoshop Start', description: 'Combiná con edición tradicional' },
        { id: 'reels-shorts-ia', title: 'Reels y Shorts con IA', description: 'Aplicá a videos cortos' },
        { id: 'contenido-redes-ia', title: 'Contenido para Redes con IA', description: 'Creá contenido completo' }
      ]
    },
    en: {
      title: 'Visual Editing with AI',
      category: 'Personal Branding & AI Content Creation',
      categoryIcon: '🌟',
      price: 28,
      hasAI: true,
      description: 'Transform images and videos into professional pieces. Master AI tools for visual editing and create high-impact content without being an expert.',
      highlights: [
        'AI image editing',
        'Automatic enhancement and retouching',
        'Background and element generation',
        'Video editing with AI tools'
      ],
      modules: [
        'Introduction to visual editing with AI',
        'Automatic image enhancement tools',
        'Generation and editing with Midjourney and DALL-E',
        'AI background and object removal',
        'Video editing with CapCut and Runway',
        'Professional AI editing workflow'
      ],
      ...
      testimonials: [
        {
          name: 'Natalia R.',
          quote: 'Now I edit my product photos in minutes. AI is magic.',
          role: 'E-commerce Owner'
        },
        {
          name: 'Gustavo P.',
          quote: 'The background removal module saved me hours of work.',
          role: 'Photographer'
        },
        {
          name: 'Micaela S.',
          quote: 'My designs now look much more professional thanks to these tools.',
          role: 'Social Media Manager'
        }
      ],
      relatedCourses: [
        { id: 'photoshop-start', title: 'Photoshop Start', description: 'Combine with traditional editing' },
        { id: 'reels-shorts-ia', title: 'Reels and Shorts with AI', description: 'Apply to short videos' },
        { id: 'contenido-redes-ia', title: 'Social Media Content with AI', description: 'Create complete content' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><Wand2 size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para editar como un profesional?' : 'Ready to edit like a professional?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y transformá tus imágenes y videos con el poder de la IA.' : 'Start today and transform your images and videos with the power of AI.'}</p>
