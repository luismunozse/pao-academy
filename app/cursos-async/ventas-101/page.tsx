...
export default function Ventas101Page() {
  ...
  const courseData = {
    es: {
      ...
      categoryIcon: '🤝',
      price: 30,
      description: 'Aprendé las técnicas básicas para cerrar más negocios. Dominá el proceso de ventas desde la prospección hasta el cierre con metodologías probadas.',
      highlights: [
      ...
      modules: [
        ...
        'Prospección: cómo encontrar clientes',
      ...
      testimonials: [
        {
          name: 'Gonzalo M.',
          quote: 'Pasé de tener miedo a vender a cerrar con confianza. Excelente curso.',
          role: 'Emprendedor'
        },
        {
          name: 'Celeste A.',
          quote: 'Las técnicas de prospección me ayudaron a triplicar mis leads.',
          role: 'Ejecutiva de Ventas'
        },
        {
          name: 'Rodrigo S.',
          quote: 'Muy práctico y aplicable desde el primer módulo.',
          role: 'Comercial'
        }
      ],
      relatedCourses: [
        { id: 'objeciones-bajo-control', title: 'Objeciones bajo Control', description: 'Dominá el arte de manejar objeciones' },
        { id: 'atencion-cliente-5star', title: 'Atención al Cliente 5 Estrellas', description: 'Fidelizá a tus clientes' },
        { id: 'comunicacion-efectiva-pro', title: 'Comunicación Efectiva Pro', description: 'Mejorá tu comunicación comercial' }
      ]
    },
    en: {
      title: 'Sales 101',
      ...
      categoryIcon: '🤝',
      price: 30,
      description: 'Learn the basic techniques to close more deals. Master the sales process from prospecting to closing with proven methodologies.',
      highlights: [
        'Step-by-step sales process',
        'Effective prospecting techniques',
        'Winning proposal presentations',
        'Proven closing techniques'
      ],
      modules: [
        'Sales process fundamentals',
        'Prospecting: how to find clients',
      ...
      testimonials: [
        {
          name: 'Gonzalo M.',
          quote: 'I went from being afraid to sell to closing with confidence. Excellent course.',
          role: 'Entrepreneur'
        },
        {
          name: 'Celeste A.',
          quote: 'The prospecting techniques helped me triple my leads.',
          role: 'Sales Executive'
        },
        {
          name: 'Rodrigo S.',
          quote: 'Very practical and applicable from the first module.',
          role: 'Sales Rep'
        }
      ],
      relatedCourses: [
        { id: 'objeciones-bajo-control', title: 'Objections Under Control', description: 'Master the art of handling objections' },
        { id: 'atencion-cliente-5star', title: '5-Star Customer Service', description: 'Build customer loyalty' },
        { id: 'comunicacion-efectiva-pro', title: 'Effective Communication Pro', description: 'Improve your sales communication' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para cerrar más ventas?' : 'Ready to close more sales?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y transformá tu forma de vender.' : 'Start today and transform the way you sell.'}</p>
          <button style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '1rem 2.5rem', fontSize: '1.125rem', fontWeight: 700, color: '#3B82F6', background: 'white', border: 'none', borderRadius: '0.75rem', cursor: 'pointer', boxShadow: '0 10px 25px rgba(0, 0, 0, 0.2)' }}>{lang === 'es' ? 'Comprar por USD $30' : 'Buy for USD $30'}<ArrowRight size={20} /></button>
        </div>
      </section>
    </div>
  );
