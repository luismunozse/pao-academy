...
export default function NotionProductividadPage() {
  const [lang, setLang] = React.useState<Lang>('es');

  const courseData = {
    es: {
      title: 'Notion para la Productividad',
      category: 'Gestión de Procesos',
      categoryIcon: '⚙️',
      price: 24,
      description: 'Organizá proyectos y tu vida laboral en un solo espacio. Aprende a usar Notion como tu centro de comando personal y profesional.',
      highlights: [
      ...
      modules: [
        'Introducción a Notion y configuración',
        'Páginas, bloques y navegación',
        'Bases de datos: tablas, kanban, calendarios',
        'Relaciones y rollups avanzados',
        'Templates y sistemas personalizados',
        'Productividad personal con Notion'
      ],
      ...
      testimonials: [
        { name: 'Valentina R.', quote: 'Notion cambió mi forma de organizar todo. Ahora tengo claridad total sobre mis proyectos.', role: 'Project Manager' },
        { name: 'Martín L.', quote: 'Las bases de datos son increíbles. Creé un CRM personalizado para mi negocio.', role: 'Emprendedor' },
        { name: 'Camila S.', quote: 'Muy práctico y fácil de seguir. Lo recomiendo para cualquier profesional.', role: 'Consultora' }
      ],
      relatedCourses: [
        { id: 'trello-asana', title: 'Trello & Asana Ágil', description: 'Gestión de equipos y tareas' },
    ...
    en: {
      ...
      categoryIcon: '⚙️',
      price: 24,
      description: 'Organize projects and your work life in one space. Learn to use Notion as your personal and professional command center.',
      highlights: [
      ...
      modules: [
        'Introduction to Notion and setup',
        'Pages, blocks and navigation',
        'Databases: tables, kanban, calendars',
        'Advanced relations and rollups',
        'Custom templates and systems',
        'Personal productivity with Notion'
      ],
      ...
      testimonials: [
        { name: 'Valentina R.', quote: 'Notion changed the way I organize everything. Now I have total clarity on my projects.', role: 'Project Manager' },
        { name: 'Martín L.', quote: 'The databases are incredible. I created a custom CRM for my business.', role: 'Entrepreneur' },
        { name: 'Camila S.', quote: 'Very practical and easy to follow. I recommend it for any professional.', role: 'Consultant' }
      ],
      relatedCourses: [
        { id: 'trello-asana', title: 'Agile Trello & Asana', description: 'Team and task management' },
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para organizar tu vida con Notion?' : 'Ready to organize your life with Notion?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y transformá tu productividad personal y profesional.' : 'Start today and transform your personal and professional productivity.'}</p>
          <button style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '1rem 2.5rem', fontSize: '1.125rem', fontWeight: 700, color: '#3B82F6', background: 'white', border: 'none', borderRadius: '0.75rem', cursor: 'pointer', boxShadow: '0 10px 25px rgba(0, 0, 0, 0.2)' }}>{lang === 'es' ? 'Comprar por USD $24' : 'Buy for USD $24'}<ArrowRight size={20} /></button>
        </div>
      </section>
    </div>
  );
