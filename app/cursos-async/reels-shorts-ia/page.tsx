...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, Video, ArrowRight, Zap, Sparkles } from 'lucide-react';
import Link from 'next/link';
import { type Lang } from '../../../lib/i18n';

export default function ReelsShortsIAPage() {
  const [lang, setLang] = React.useState<Lang>('es');

  const courseData = {
    es: {
      title: 'Reels y Shorts con IA',
      category: 'Marca Personal y Creación de Contenido con IA',
      categoryIcon: '🌟',
      price: 33,
      hasAI: true,
      description: 'Crea videos virales con guiones y edición inteligente. Aprendé a producir Reels e Instagram Stories y YouTube Shorts de alto impacto usando herramientas de IA.',
      highlights: [
        'Guiones virales con ChatGPT',
        'Edición con herramientas de IA',
        'Hooks que capturan atención',
        'Tendencias y formatos que funcionan'
      ],
      modules: [
        'Anatomía de un video viral',
        'Guiones irresistibles con IA',
        'Hooks que detienen el scroll',
        'Edición rápida con CapCut y herramientas IA',
        'Música, efectos y subtítulos automáticos',
      ...
      testimonials: [
        {
          name: 'Valentina G.',
          quote: 'Mi primer reel con estas técnicas llegó a 100k views. Increíble.',
          role: 'Creadora de Contenido'
        },
        {
          name: 'Sebastián M.',
          quote: 'Los guiones con IA me ahorran horas de trabajo. Muy recomendado.',
          role: 'Emprendedor'
        },
        {
          name: 'Florencia A.',
          quote: 'El módulo de hooks cambió mis videos por completo. Mucho más engagement.',
          role: 'Community Manager'
        }
      ],
      relatedCourses: [
        { id: 'contenido-redes-ia', title: 'Contenido para Redes con IA', description: 'Expandí tu creación de contenido' },
        { id: 'edicion-visual-ia', title: 'Edición Visual con IA', description: 'Mejorá tu edición' },
        { id: 'marca-personal-360', title: 'Tu Marca Personal 360', description: 'Construí tu marca' }
      ]
    },
    en: {
      title: 'Reels and Shorts with AI',
      category: 'Personal Branding & AI Content Creation',
      categoryIcon: '🌟',
      price: 33,
      hasAI: true,
      description: 'Create viral videos with intelligent scripts and editing. Learn to produce high-impact Reels, Instagram Stories and YouTube Shorts using AI tools.',
      highlights: [
        'Viral scripts with ChatGPT',
        'Editing with AI tools',
        'Hooks that capture attention',
        'Trends and formats that work'
      ],
      modules: [
        'Anatomy of a viral video',
        'Irresistible scripts with AI',
        'Hooks that stop the scroll',
        'Quick editing with CapCut and AI tools',
        'Music, effects and automatic subtitles',
        'Publishing and optimization for each platform'
      ],
      ...
      testimonials: [
        {
          name: 'Valentina G.',
          quote: 'My first reel with these techniques reached 100k views. Incredible.',
          role: 'Content Creator'
        },
        {
          name: 'Sebastián M.',
          quote: 'AI scripts save me hours of work. Highly recommended.',
          role: 'Entrepreneur'
        },
        {
          name: 'Florencia A.',
          quote: 'The hooks module completely changed my videos. Much more engagement.',
          role: 'Community Manager'
        }
      ],
      relatedCourses: [
        { id: 'contenido-redes-ia', title: 'Social Media Content with AI', description: 'Expand your content creation' },
        { id: 'edicion-visual-ia', title: 'Visual Editing with AI', description: 'Improve your editing' },
        { id: 'marca-personal-360', title: 'Your 360 Personal Brand', description: 'Build your brand' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><Video size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para crear videos virales?' : 'Ready to create viral videos?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y dominá el formato de video corto con IA.' : 'Start today and master the short video format with AI.'}</p>
          <button style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '1rem 2.5rem', fontSize: '1.125rem', fontWeight: 700, color: '#3B82F6', background: 'white', border: 'none', borderRadius: '0.75rem', cursor: 'pointer', boxShadow: '0 10px 25px rgba(0, 0, 0, 0.2)' }}>{lang === 'es' ? 'Comprar por USD $33' : 'Buy for USD $33'}<ArrowRight size={20} /></button>
        </div>
      </section>
    </div>
  );
