...
import { ArrowLeft, Clock, Award, CheckCircle2, Star, Play, Layout, ArrowRight, Zap } from 'lucide-react';
import Link from 'next/link';
import { type Lang } from '../../../lib/i18n';

export default function UXUIFundamentalsPage() {
  ...
  const courseData = {
    es: {
      ...
      categoryIcon: '🎨',
      price: 42,
      description: 'Los secretos del diseño digital centrado en el usuario. Aprendé los principios fundamentales de UX/UI para crear productos digitales que los usuarios amen.',
      highlights: [
        'Principios de diseño centrado en el usuario',
        'Wireframing y prototipado',
        'Diseño de interfaces efectivas',
        'Usabilidad y testing básico'
      ],
      modules: [
        'Introducción a UX y UI: diferencias y sinergias',
        'Investigación de usuarios y personas',
        'Arquitectura de información',
        'Wireframes: de la idea al boceto',
        'Principios de diseño visual para UI',
        'Prototipado y testing de usabilidad'
      ],
      duration: '9 horas de contenido',
      ...
      testimonials: [
        {
          name: 'Camila R.',
          quote: 'Este curso me abrió las puertas al mundo del diseño UX. Muy completo.',
          role: 'Diseñadora Junior'
        },
        {
          name: 'Fernando T.',
          quote: 'Entendí por fin la diferencia entre UX y UI y cómo aplicarlo en mis proyectos.',
          role: 'Desarrollador Frontend'
        },
        {
          name: 'Mariana G.',
          quote: 'El módulo de wireframing es excelente. Ahora puedo comunicar mis ideas visualmente.',
          role: 'Product Manager'
        }
      ],
      relatedCourses: [
        { id: 'diseno-canva', title: 'Diseño con Canva', description: 'Complementá con diseño gráfico' },
        { id: 'photoshop-start', title: 'Photoshop Start', description: 'Dominá la edición de imágenes' },
        { id: 'marca-personal-360', title: 'Tu Marca Personal 360', description: 'Aplicá UX a tu marca' }
      ]
    },
    en: {
      title: 'UX/UI Fundamentals',
      ...
      categoryIcon: '🎨',
      price: 42,
      description: 'The secrets of user-centered digital design. Learn the fundamental principles of UX/UI to create digital products that users love.',
      highlights: [
        'User-centered design principles',
        'Wireframing and prototyping',
        'Effective interface design',
        'Usability and basic testing'
      ],
      modules: [
        'Introduction to UX and UI: differences and synergies',
        'User research and personas',
        'Information architecture',
        'Wireframes: from idea to sketch',
        'Visual design principles for UI',
        'Prototyping and usability testing'
      ],
      duration: '9 hours of content',
      format: '100% on-demand',
      ...
      testimonials: [
        {
          name: 'Camila R.',
          quote: 'This course opened the doors to the UX design world for me. Very complete.',
          role: 'Junior Designer'
        },
        {
          name: 'Fernando T.',
          quote: 'I finally understood the difference between UX and UI and how to apply it to my projects.',
          role: 'Frontend Developer'
        },
        {
          name: 'Mariana G.',
          quote: 'The wireframing module is excellent. Now I can communicate my ideas visually.',
          role: 'Product Manager'
        }
      ],
      relatedCourses: [
        { id: 'diseno-canva', title: 'Design with Canva', description: 'Complement with graphic design' },
        { id: 'photoshop-start', title: 'Photoshop Start', description: 'Master image editing' },
        { id: 'marca-personal-360', title: 'Your 360 Personal Brand', description: 'Apply UX to your brand' }
      ]
    }
  };
    ...
    <div style={{ minHeight: '100vh', background: '#FFFFFF' }}>
      ...
      <section style={{ padding: '0', background: '#F8FAFC' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1rem' }}>
          <div style={{ background: 'linear-gradient(135deg, #E2E8F0 0%, #CBD5E1 100%)', borderRadius: '0 0 1rem 1rem', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-2rem', position: 'relative', zIndex: 10 }}>
            <div style={{ textAlign: 'center', color: '#64748B' }}><Layout size={64} style={{ marginBottom: '1rem', opacity: 0.5 }} /><p style={{ fontSize: '1rem' }}>{lang === 'es' ? 'Vista previa del curso' : 'Course preview'}</p></div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '4rem 1rem', background: 'linear-gradient(135deg, #3B82F6 0%, #8B5CF6 100%)', textAlign: 'center' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '2rem', fontWeight: 700, color: 'white', marginBottom: '1rem' }}>{lang === 'es' ? '¿Listo para diseñar experiencias increíbles?' : 'Ready to design amazing experiences?'}</h2>
          <p style={{ fontSize: '1.125rem', color: 'rgba(255,255,255,0.9)', marginBottom: '2rem' }}>{lang === 'es' ? 'Empezá hoy y aprendé a crear productos digitales que los usuarios amen.' : 'Start today and learn to create digital products that users love.'}</p>
          <button style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '1rem 2.5rem', fontSize: '1.125rem', fontWeight: 700, color: '#3B82F6', background: 'white', border: 'none', borderRadius: '0.75rem', cursor: 'pointer', boxShadow: '0 10px 25px rgba(0, 0, 0, 0.2)' }}>{lang === 'es' ? 'Comprar por USD $42' : 'Buy for USD $42'}<ArrowRight size={20} /></button>
        </div>
      </section>
    </div>
  );
