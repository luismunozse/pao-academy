          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-2 text-white/90 text-sm">
                ...
                <span className="text-white/87">· {course.students}+ {t('students')}</span>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2 text-white/90 group-hover:text-[color:var(--academic-secondary)] transition-colors duration-300">
